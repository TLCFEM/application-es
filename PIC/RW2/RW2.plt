...
set grid
set border 15
plot "RW2-EXP" using 1:($2)/100 w l lw 2 dt 2 lc rgb "#333333" title "experiment",\
     "RW2-2X2" every 2 using 1:($2)/100000 w l lw 2 lc rgb "#ff0000" title "simulation"
set output